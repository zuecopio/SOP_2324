/*-----------------------------------------------------+
 ...
 |     Descripción : Analiza los argumentos de la orden|
 +-----------------------------------------------------*/
...
int  analizar (char *s ) 
{
   ...
   //-----[ AÑADIDO POR EL ALUMNO ]----------------------(+)
     ...
     int leng_s = strlen(s);                  // Longitud de la orden original
     int leng_lineptr = strlen(lineptr);      // Longitud de la parte erronea de la orden
     int leng_direccion = strlen(direccion);  // Longitud del directorio actual
     int leng_PROMPT = strlen(PROMPT);        // Longitud del PROMPT
   
     charok = leng_direccion + leng_PROMPT + (leng_s -leng_lineptr);
   
   //----------------------------------------------------(-)
 
 
   //-----[ ELIMINADO POR EL ALUMNO ]--------------------(+)
   ...
   fprintf(stderr, RED "^" RESET_COLOR " inesperado\n");
